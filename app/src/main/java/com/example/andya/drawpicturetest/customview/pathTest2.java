...
/**
 * Created by andya on 2017/10/21.
 */
...
public class pathTest2 extends View {
    ...
    public pathTest2(Context context) {
        this(context,null);
    }

    public pathTest2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAll();
    }
    public pathTest2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAnimator() {
        mStartingAnimator = ValueAnimator.ofFloat(0, 1).setDuration(0);
        mSearchingAnimator = ValueAnimator.ofFloat(0, 1).setDuration(defaultDuration);
        mEndingAnimator = ValueAnimator.ofFloat(1, 0).setDuration(0);
